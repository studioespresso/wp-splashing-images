...
class Wp_Splashing {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp_Splashing_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wp_Splashing_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Splashing_i18n. Defines internationalization functionality.
	 * - Wp_Splashing_Admin. Defines all hooks for the admin area.
	 * - Wp_Splashing_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-splashing-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-splashing-i18n.php';
	 ...
	 *
	 * Uses the Wp_Splashing_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wp_Splashing_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Splashing_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wp_Splashing_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp_Splashing_Loader    Orchestrates the hooks of the plugin.
	 */
