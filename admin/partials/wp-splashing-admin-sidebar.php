        ...
        <div class="inside">
            <div class="media-toolbar-search-splashing">
                ...
                <form id="splashing-search" method="get" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    ...
                    <input type="search" id="post-search-input-splashing" name="search" value="<?php echo sanitize_title_for_query($_GET['search']); ?>" placeholder="<?php _e('Search unsplash.com', 'wp-splashing-images'); ?>">
